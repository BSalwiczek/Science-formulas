...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Logarytmy','Logarithm') ?></title>
...
?>
	...
	<div id="content" class="content2">
		<div id="tree">
			<a href="../science-formulas"><img src="img/home_icon.png"/></a> > <a href="<?php setLangText('matematyka','math') ?>"><?php setLangText('Matematyka','Math') ?></a> > <a href="<?php setLangText('matematyka-algebra','math-algebra') ?>"><?php setLangText('Algebra','Algebra') ?></a> > <a href=""><?php setLangText('Logarytmy','Logarithm') ?></a>
		</div>
<?php
	require_once("../../../createContentMenu.php");
	createContentMenu('../../../../','Math/Algebra/Logarithm','Logarithm');
?>
