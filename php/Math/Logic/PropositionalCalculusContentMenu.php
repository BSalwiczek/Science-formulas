...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Rachunek zdań','Propositional calculus') ?></title>
...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li><a href="<?php setLangText('matematyka-logika','math-logic') ?>"><?php setLangText('Logika','Logic')?></a></li>
	  <li class="active"><?php setLangText('Rachunek zdań','Propositional calculus') ?></li>
	</ul>
<?php		
	require_once("../../createContentMenu.php");
	createContentMenu('../../../','Math/Logic/PropositionalCalculus','PropositionalCalculus');
?>		
