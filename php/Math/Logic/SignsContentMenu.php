...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Oznaczenia teoria mnogości','Signs in set theory') ?></title>
...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li class="active"><?php setLangText('Oznaczenia','Signs') ?></li>
	</ul>
<?php		
	require_once("../../createContentMenu.php");
	createContentMenu('../../../','Math/Logic/Signs','Signs');
?>		
