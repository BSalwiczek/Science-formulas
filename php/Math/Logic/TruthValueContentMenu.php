...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Wartość logiczna','Truth value') ?></title>
...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li class="active"><?php setLangText('Wartość logiczna','Truth value') ?></li>
	</ul>
<?php		
	require_once("../../createContentMenu.php");
	createContentMenu('../../../','Math/Logic/TruthValue','TruthValue');
?>		
