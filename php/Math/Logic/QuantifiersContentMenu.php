...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Kwalifikatory','Quantifiers') ?></title>
...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li class="active"><?php setLangText('Kwalifikatory','Quantifiers') ?></li>
	</ul>
<?php		
	require_once("../../createContentMenu.php");
	createContentMenu('../../../','Math/Logic/Quantifiers','Quantifiers');
?>		
