...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Funkcje trygonometryczne','Trygonometry functions') ?></title>
...
?>
	...
	<div id="content" class="content2">
		<div id="tree">
			<a href="../science-formulas"><img src="img/home_icon.png"/></a> > <a href="<?php setLangText('matematyka','math') ?>"><?php setLangText('Matematyka','Math') ?></a> > <a href="<?php setLangText('matematyka-geometria','math-geometry') ?>"><?php setLangText('Geometria','Geometry') ?></a> > <a href=""><?php setLangText('Funkcje Trygonometryczne','Trygonomtry functions') ?></a>
		</div>
<?php		
	require_once("../../../createContentMenu.php");
	createContentMenu('../../../../','Math/Geometry/TrygFunctions','trygFunctions');
?>		
