...
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText('Pole powierzchni','Area') ?></title>
...
?>
	...
	<div id="content" class="content2">
		<div id="tree">
			<a href="../science-formulas"><img src="img/home_icon.png"/></a> > <a href="math-categories"><?php setLangText('Matematyka','Math') ?></a> > <a href="math-geometry-categories"><?php setLangText('Geometria','Geometry') ?></a> > <a href="math-geometry-area-categories"><?php setLangText('Pole powierzchni','Area') ?></a>
		</div>
<?php		
	require_once("../../../createContentMenu.php");
	createContentMenu('../../../../','Math/Geometry/Area','Area');
?>		
