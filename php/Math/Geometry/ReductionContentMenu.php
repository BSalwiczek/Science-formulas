...
?>
<?php
	$titPL = 'Redukcja funkcji trygonometrycznych';
	$titEN = 'Reduction of trygonometry functions';
?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset = "utf-8"/>
	<title><?php setLangText($titPL,$titEN) ?></title>
...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li><a href="<?php setLangText('matematyka-geometria','math-geometry') ?>"><?php setLangText('Geometria','Geometry')?></a></li>
	  <li class="active"><?php setLangText($titPL,$titEN) ?></li>
	</ul>

<?php		
	require_once("../../createContentMenu.php");
	createContentMenu('../../../','Math/Geometry/ReductionContentMenu','ReductionContentMenu');
?>		
