...
?>
	...
	<ul class="breadcrumb" style="text-align:left">
	  ...
	  <li><a href="<?php setLangText('fizyka-astrofizyka','physics-astrophysics') ?>"><?php setLangText('Astrofizyka','Astrophysics')?></a></li>
	  <li class="active"><?php setLangText('Czarne dziury','Black holes') ?></li>
	</ul>
